...
const MultipleSelector = ({
  ...
  return (
    ...
    >
      <div
        className={cn(
          'border-input focus-within:ring-muted-foreground/40 has-aria-invalid:ring-destructive/20 dark:has-aria-invalid:ring-destructive/40 has-aria-invalid:border-destructive relative min-h-[38px] rounded-md border text-sm transition-[color,box-shadow] outline-none focus-within:ring-2 has-disabled:pointer-events-none has-disabled:cursor-not-allowed has-disabled:opacity-50',
          {
      ...
      >
        <div className='flex flex-wrap gap-1'>
          ...
          <CommandPrimitive.Input
            ...
            className={cn(
              'placeholder:text-muted-foreground font-semibold flex-1 bg-transparent outline-hidden disabled:cursor-not-allowed',
              {
                        ...
                        {dropdowns.map((option) => {
                          return (
                            <CommandItem
                              ...
                              className={cn(
                                'cursor-pointer font-semibold text-muted-foreground text-xs px-4 py-2',
                                option.disable &&
